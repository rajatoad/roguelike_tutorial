...
const entity_types = {
	...
	"priest": "res://assets/definitions/entities/actors/entity_definition_priest.tres",
	"crusader": "res://assets/definitions/entities/actors/entity_definition_crusader.tres",
